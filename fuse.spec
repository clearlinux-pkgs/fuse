...
Source0  : https://github.com/libfuse/libfuse/releases/download/fuse-3.12.0/fuse-3.12.0.tar.xz
Source1  : https://github.com/libfuse/libfuse/releases/download/fuse-3.12.0/fuse-3.12.0.tar.xz.asc
...
%prep
%setup -q -n fuse-3.12.0
cd %{_builddir}/fuse-3.12.0
%patch1 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1662647426
