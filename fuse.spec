...
Version  : 3.9.3
Release  : 40
URL      : https://github.com/libfuse/libfuse/releases/download/fuse-3.9.3/fuse-3.9.3.tar.xz
Source0  : https://github.com/libfuse/libfuse/releases/download/fuse-3.9.3/fuse-3.9.3.tar.xz
Source1  : https://github.com/libfuse/libfuse/releases/download/fuse-3.9.3/fuse-3.9.3.tar.xz.asc
...
%prep
%setup -q -n fuse-3.9.3
cd %{_builddir}/fuse-3.9.3
%patch1 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1597163002
...
cp %{_builddir}/fuse-3.9.3/GPL2.txt %{buildroot}/usr/share/package-licenses/fuse/4cc77b90af91e615a64ae04893fdffa7939db84c
