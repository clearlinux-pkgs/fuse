...
%package dev32
Summary: dev32 components for the fuse package.
Group: Default
Requires: fuse-lib32 = %{version}-%{release}
Requires: fuse-bin = %{version}-%{release}
Requires: fuse-dev = %{version}-%{release}

%description dev32
dev32 components for the fuse package.
...
%package lib32
Summary: lib32 components for the fuse package.
Group: Default
Requires: fuse-license = %{version}-%{release}

%description lib32
lib32 components for the fuse package.
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1738109744
...
%files dev32
%defattr(-,root,root,-)
/usr/lib32/libfuse3.so
/usr/lib32/pkgconfig/32fuse3.pc
/usr/lib32/pkgconfig/fuse3.pc
...
%files lib32
%defattr(-,root,root,-)
/usr/lib32/libfuse3.so.3
/usr/lib32/libfuse3.so.3.16.2
